  ...
  return (
    <div className='flex min-h-screen items-center  justify-center px-4 '>
      <div className='w-full max-w-sm space-y-6'>
        ...
        <button disabled={!role} onClick={addRole} className={`w-full rounded-xl px-4 py-3 text-sm fonts-semibold transition ${
          role ? "border-[#E23744] bg-[#E23744] text-white hover:bg[#d32f3a]": "bg-gray-200 text-gray-400 cursor-not-allowed"
        }`}>Next</button>
      </div>
    </div>
  )
